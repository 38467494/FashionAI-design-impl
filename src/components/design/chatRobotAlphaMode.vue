<template>
  <div>
    <div class="chatAppBody">
      <section class="flex">
        <section class="grow chatTitleAlpha">
          时尚小谙Alpha
          <ats-button @click="changeMode($event)">beta</ats-button>
        </section>
...
export default {
  ...
  data() {
    return {
      ...
      questionList:[
        ...
        {
          message: '可以告诉小谙您的外形描述吗？比如身材、肤色、发型等。',
          appendix: '【忽略此问题】',
          field: 2,
        },
        {
          message: '您想穿上去看起来达到什么效果呢？比如休闲、正式、帅气、端庄等。',
          appendix: '【忽略此问题】',
          field: 2,
        },
        {
          message: '最后您还有什么其他需求要告诉小谙的吗？',
          appendix: '【忽略此问题】',
          field: 2,
        },
      ],
  ...
  methods: {
    changeMode:function(e){
      this.$emit("changeMode",e.currentTarget, true);
    },
    showCheckBox(){
